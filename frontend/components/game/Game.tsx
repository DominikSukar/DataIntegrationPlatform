...
function Game({ match}: { match: MatchData}) {
  ...
  return (
    <div
      className={`bg-white bg-opacity-20 backdrop-blur-md lg:rounded-l-full border-4 xl:w-[900px]
         rounded-[10px] m-1 p-1 lg:px-5 flex items-center justify-around lg:gap-5
